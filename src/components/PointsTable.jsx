...
import acceptPng from "../assets/accept.png"
...
function PointsTable() {
  ...
  <table className="w-[90%]  mt-10  tabby:w-[95%] tabby:px-2">
    <tr className="text-[17px] text-gray-800/50 font-medium flex justify-between text-left pr-5 py-3 tabby:text-[10px]  ">
      <td className="w-[40%] tabby:w-[20%]">Team</td>
      <div className="flex justify-between w-[10%] text-left tabby:w-[15%]">
      <td>M</td>
      <td>W</td>
      <td>L</td>
      </div>
      <td>NRR</td>
      <td className="text-black text-left w-6 ">Pts</td>
      <td>Last 5</td>
    </tr>
    {
      tableData.map(({teamImageId,teamName,matchesLost,matchesPlayed,matchesWon,nrr,points,form},i)=>{
           return   <tr className="text-[17px] text-black flex justify-between  border-t border-gray-400/50 py-2 tabby:text-[10px]">
          <div className="flex gap-3 w-[40%] tabby:w-[20%]">
          <td className="w-4 text-center tabby:w-2">{i+1}</td>
           <img className="w-4 object-contain tabby:w-3" src={`https://res.cloudinary.com/digkgdovw/image/upload/v1715267905/iplTeamLogo/${teamImageId}`} alt="" />
           <td className="tabby:text-[10px]">{teamName}</td>
          </div>
           <div className="flex justify-between w-[10%] text-left tabby:w-[15%]">
           <td className="w-4 text-left">{matchesPlayed}</td>
           <td className="w-4 text-left">{matchesWon}</td>
           <td className="w-4 text-left">{matchesLost}</td>
           </div>
           <td className=" text-left">{nrr}</td>
           <td className="w-4 text-left text-black">{points}</td>
           <td>
            <div className="flex gap-1 justify-center">
              {
                form.map((one)=>{
                  return one==="W"?<img className="w-4 tabby:w-3 object-contain" src={acceptPng}></img>:<img className="w-4 tabby:w-3 object-contain" src={cross}></img>
                })
              }
            </div>
           </td>
