...
function Home() {
  ...
  let filterData = data.matchDetails.filter((onematch) => {
    return onematch.matchDetailsMap;
  });
  ...
  return (
    <div>
      {matchesData ? (
        <div className="w-full flex  flex-wrap bg-white text-black justify-center ">
          {matchesData.map(({ matchDetailsMap: { key: date, match } }, i) =>
            match.map(
              ({
                matchInfo: {
                  matchDesc,
                  team1: { teamSName: left, imageId: leftImageId },
                  team2: { teamSName: right, imageId: rightImageId },
                  status,
                  matchId,
                },
                matchScore,
                ...
                <Link
                  ...
                  className="block w-[100%] min-h-[150px] md:w-[50%]   "
                >
                  <div className=" border border-gray-300 px-5 py-3 md:px-3  flex flex-col gap-3 text-[14px] h-full md:text-[17px] w-full ">
                    ...
                    <div className="flex flex-col-reverse gap-2 ">
                      <div className="flex justify-between ">
                        <div className="flex w-[20%] justify-between">
                          <img
                            ...
                            src={`https://res.cloudinary.com/digkgdovw/image/upload/v1715267905/iplTeamLogo/${leftImageId}`}
                            alt=""
                          />
                          <p className=" text-[15px] md:text-[18px]">{left}</p>
                        </div>
                        <p>
                      ...
                      <div className="flex justify-between ">
                        <div className="flex w-[20%] justify-between">
                          <img
                            className="w-4 object-contain"
                            src={`https://res.cloudinary.com/digkgdovw/image/upload/v1715267905/iplTeamLogo/${rightImageId}`}
                            alt=""
                          />
                          <p className=" text-[15px] md:text-[18px]">{right}</p>
                        </div>
                        <p>
                    ...
                    <p className="text-gray-700/70 text-[14px] md:text-[17px] ">
                      {status}
                    </p>
                  </div>
                </Link>
